...
import { SECTOR_20090 } from '@/data/sector-content/20090'
...
const SECTOR = SECTOR_20090
const POSTAL_CODE = '20090'
const ZONE_LABEL = "Aspretto · Campo dell'Oro · Les Cannes · Pietrina"
...
export default async function Marche20090Page() {
  ...
  return (
    <main className="pt-28 pb-16">
      ...
      <div className="bg-[#FAF5EC]/60 mt-16 py-16 border-y border-[#C9A96E]/10">
        <div className="max-w-6xl mx-auto px-4 space-y-10">
          <SectionHeading
            ...
            title="Ajaccio sud — un marché résidentiel et littoral"
            description="Sept questions essentielles pour cadrer la lecture immobilière du 20090."
          />
        ...
        <div className="max-w-6xl mx-auto px-4 space-y-12">
          <div className="space-y-8">
            <SectionHeading
              ...
              description="Comprendre Ajaccio dans son ensemble pour mieux interpréter les chiffres du 20090."
            />
      ...
      <div className="bg-[#FAF5EC]/60 py-16 border-y border-[#C9A96E]/10">
        <div className="max-w-6xl mx-auto px-4 space-y-8">
          <SectionHeading
            ...
            title={`Tout ce qu'on nous demande sur le 20090`}
      ...
      {/* ─── CTA BOTTOM ────────────────────────────────────────────────── */}
      <div className="max-w-6xl mx-auto px-4 mt-16">
        <MarketCTA variant="bottom" postalCode={POSTAL_CODE} zone="Ajaccio sud" />
      </div>
